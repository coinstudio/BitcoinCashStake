#############################################################################
# Makefile for building: bitcoincashstake-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: Mon Oct 16 06:33:25 2017
# Project:  BitcoinCashStake-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake RELEASE=1 -o Makefile BitcoinCashStake-qt.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -Wl,-Bstatic -lminiupnpc /tmp/BitcoinCashStake/src/leveldb/libleveldb.a /tmp/BitcoinCashStake/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -Wl,-Bdynamic -lrt -ldl -lpthread -lQtGui -lQtCore 
AR            = ar cqs
RANLIB        = 
...
DIST          = /usr/share/qt4/mkspecs/common/unix.conf \
		...
		BitcoinCashStake-qt.pro
QMAKE_TARGET  = bitcoincashstake-qt
DESTDIR       = 
...
Makefile: BitcoinCashStake-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) RELEASE=1 -o Makefile BitcoinCashStake-qt.pro
...
/tmp/BitcoinCashStake/src/leveldb/libleveldb.a: FORCE
	cd /tmp/BitcoinCashStake/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/tmp/BitcoinCashStake/build/build.h: FORCE
	cd /tmp/BitcoinCashStake; /bin/sh share/genbuild.sh /tmp/BitcoinCashStake/build/build.h
